...
var Carousel = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(CarouselContext.Provider, { value: {
        ...
        React.createElement("div", __assign({ ref: ref, onKeyDownCapture: handleKeyDown, className: cn("relative", className), role: "region", "aria-roledescription": "carousel" }, props), children)));
});
...
var CarouselContent = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("div", { ref: carouselRef, className: "overflow-hidden" },
        React.createElement("div", __assign({ ref: ref, className: cn("flex", orientation === "horizontal" ? "-ml-4" : "-mt-4 flex-col", className) }, props))));
});
CarouselContent.displayName = "CarouselContent";
var CarouselItem = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var orientation = useCarousel().orientation;
    return (React.createElement("div", __assign({ ref: ref, role: "group", "aria-roledescription": "slide", className: cn("min-w-0 shrink-0 grow-0 basis-full", orientation === "horizontal" ? "pl-4" : "pt-4", className) }, props)));
});
...
var CarouselPrevious = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(Button, __assign({ ref: ref, variant: variant, size: size, className: cn("absolute  h-8 w-8 rounded-full", orientation === "horizontal"
